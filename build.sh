...
if [[ "$OSTYPE" == "msys" ]] || [[ "$OSTYPE" == "mingw"* ]] || [[ "$OSTYPE" == "cygwin"* ]] || [[ -n "$WINDIR" ]]; then
    ...
    EXE_EXT=".exe"
    SOCKET_LIB="-lws2_32"
    SDL_FLAGS="-lmingw32 -lSDLmain -lSDL -lSDL_ttf"
...
echo ""
echo "Make sure assets/font.ttf exists before running the client!"
echo ""
echo "To run:"
